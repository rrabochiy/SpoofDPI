...
curl "https://api.github.com/repos/rrabochiy/SpoofDPI/releases/latest" |
    grep '"tag_name":' |
    sed -E 's/.*"([^"]+)".*/\1/' |
    xargs -I {} curl -OL "https://github.com/rrabochiy/SpoofDPI/releases/download/"\{\}"/spoof-dpi-${1}.tar.gz"
